...
export default class FeedRightSidebar extends Component {
  render() {
    return (
      <div>
        {/* first card  */}
        <Card className="text-capitalize pt-2 pb-1 mb-3">
          <small className="text-muted ml-auto mr-3">
            Ad
          ...
          <Card.Body>
            ...
            <div style={{ textAlign: "center" }}>
              <small>Hello,transunion is hiring!</small>
        ...
        <Card className="text-capitalize pt-3 pb-3 mb-3">
          <ListGroup>
            <small className="pl-3">
              Add to your feed
              <BsInfoCircle style={{ float: "right" }} className="mr-3" />
            </small>
            <Suggestion
              isBtn={true}
              src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"
            ...
            <Suggestion
              ...
              subtext="HR||open for collaboration"
            />
            <a href="#" className="pl-3" style={{ fontSize: "13px" }}>
